...
const AdminUploadedits = (props) => {
  ...
  const handleUploads = async () => {
    ...
    await axios({
      ...
      url: `${process.env.REACT_APP_API_URL}/users/adminuploadedits`,
      method: "POST",
      data: formData,
      headers: {
              ...
              <div className="card-body" style={{ minHeight: "550px" }}>
                ...
                <div className="invoice-details">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      Upload Completed work to clients
...
export default AdminUploadedits;
